...
<h4>you just need an Access Key, wich you can get from <a href="https://t.me/GALGENTool_bot">@CarParkingTool_bot</a> for free with 1K Credits Balance.</h4>
...
```
git clone https://github.com/Daniil200017/GalagenTool2.git
```
```
cd carparktool.py
```
